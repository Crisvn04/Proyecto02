...
AS 
   ...
   (
      ...
      CONSTRAINT PK_RolesID PRIMARY KEY (rolID),
...
IF @Rol = 'ADMIN'
    BEGIN 
       Select Usuarios.UsuarioID, Usuarios.Nombre, Equipos. TipoEquipo,
       Equipos.Modelo, Reparaciones.Estado, DetallesRepacion.Descripcion,
       Tecnicos.Nombre, Tecnicos.Especialidad, Asignaciones.FechaAsignacion
       ...
       INNER JOIN DetallesRepacion ON DetallesRepacion.ReparacionID  = Reparaciones.ReparacionID
...
ELSE
       ...
       INNER JOIN Asignaciones ON Asignaciones.ReparacionID = Reparaciones.ReparacionID
       INNER JOIN Tecnicos ON Tecnicos.TecnicoID = Asignaciones.TecnicoID 
       WHERE Tecnicos.TecnicoID = @TecID
